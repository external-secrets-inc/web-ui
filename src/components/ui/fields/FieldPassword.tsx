...
export interface FieldPasswordProps extends Omit<ComponentPropsWithoutRef<typeof Input>, 'name'> {
  name: string;
  label: string;
  description?: string;
  required?: boolean;
...
export const FieldPassword = forwardRef<HTMLInputElement, FieldPasswordProps>(
