...
import { FederationCreateWithYaml } from "./FederationCreateWithYaml";
import { FederationCreateWithEsiSchemaForm } from "./FederationCreateWithEsiSchemaForm";
...
export function FederationCreate() {
  ...
  return (
    <>
      ...
      {formMode === "yaml" ? (
        <FederationCreateWithYaml />
      ) : (
        <FederationCreateWithEsiSchemaForm />
      )}
    </>
  );
}
