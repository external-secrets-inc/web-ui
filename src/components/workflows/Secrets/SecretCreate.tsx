...
import { SecretCreateWithYaml } from "./SecretCreateWithYaml";
import { SecretCreateWithEsiSchemaForm } from "./SecretCreateWithEsiSchemaForm";
...
export function SecretCreate() {
  ...
  return (
    <>
      ...
      {formMode === "yaml" ? (
        <SecretCreateWithYaml />
      ) : (
        <SecretCreateWithEsiSchemaForm />
      )}
    </>
  );
}
