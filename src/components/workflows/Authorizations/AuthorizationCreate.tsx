...
import { AuthorizationCreateWithYaml } from "./AuthorizationCreateWithYaml";
import { AuthorizationCreateWithEsiSchemaForm } from "./AuthorizationCreateWithEsiSchemaForm";
...
export function AuthorizationCreate() {
  ...
  return (
    <>
      ...
      {formMode === "yaml" ? (
        <AuthorizationCreateWithYaml />
      ) : (
        <AuthorizationCreateWithEsiSchemaForm />
      )}
    </>
  );
}
