...
import { TargetCreateWithYaml } from "./TargetCreateWithYaml";
import { TargetCreateWithEsiSchemaForm } from "./TargetCreateWithEsiSchemaForm";
...
export function TargetCreate() {
  ...
  return (
    <>
      ...
      {formMode === "yaml" ? (
        <TargetCreateWithYaml />
      ) : (
        <TargetCreateWithEsiSchemaForm />
      )}
    </>
  );
}