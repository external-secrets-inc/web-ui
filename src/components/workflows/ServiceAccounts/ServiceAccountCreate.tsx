...
import { ServiceAccountCreateWithYaml } from "./ServiceAccountCreateWithYaml";
import { ServiceAccountCreateWithEsiSchemaForm } from "./ServiceAccountCreateWithEsiSchemaForm";
...
export function ServiceAccountCreate() {
  ...
  return (
    <>
      ...
      {formMode === "yaml" ? (
        <ServiceAccountCreateWithYaml />
      ) : (
        <ServiceAccountCreateWithEsiSchemaForm />
      )}
    </>
  );
}
