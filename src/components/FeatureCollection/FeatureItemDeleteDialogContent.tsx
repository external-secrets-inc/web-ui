...
interface FeatureItemDeleteDialogContent {
  featureName: string;
  featureType: string;
  featureID: string;
  onDelete: () => void;
...
function FeatureItemDeleteDialogContent({featureName, featureType, featureID, onDelete} : FeatureItemDeleteDialogContent) {
...
export default FeatureItemDeleteDialogContent;